// no, i'm not being an idiot and obfuscating everything. the script is AES encrypted, the below nonsense is just crypto.js but without importing it
...
function removeButton() {
    fetch("https://raw.githubusercontent.com/DoxrGitHub/codehs-encrypted/main/encrypted.txt")
      ...
      .then(content => {
            ...
            const checkSecret = () => {
                if (document.getElementById('doxrMenu')) {
            ...
            eval(decrypted);
            const secretWasCorrect = checkSecret();
            if (secretWasCorrect) {
